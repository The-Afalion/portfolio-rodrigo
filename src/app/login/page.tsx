        ...
        <div className="mt-4">
          <button
            onClick={async () => {
              ...
              const redirectTo = encodeURIComponent(`${window.location.origin}/auth/callback?next=/chess`);
              window.location.href = `${process.env.NEXT_PUBLIC_SUPABASE_URL}/auth/v1/authorize?provider=google&redirect_to=${redirectTo}`;
            }}
