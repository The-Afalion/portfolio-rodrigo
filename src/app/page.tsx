    ...
    <main className="min-h-screen bg-black text-white selection:bg-white selection:text-black overflow-hidden relative">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">
          ...
          <Link href="/engineering" className="group relative overflow-hidden rounded-2xl bg-neutral-900/50 border border-neutral-800 p-8 hover:border-neutral-600 transition-all duration-500 hover:shadow-[0_0_30px_rgba(255,255,255,0.1)] backdrop-blur-sm">
          ...
          {/* Puerta 2: Chess Hub */}
          <Link href="/chess" className="group relative overflow-hidden rounded-2xl bg-neutral-900/50 border border-neutral-800 p-8 hover:border-neutral-600 transition-all duration-500 hover:shadow-[0_0_30px_rgba(255,255,255,0.1)] backdrop-blur-sm">
