...
export default async function ProjectsSocialPage() {
  ...
  return (
    <div className="relative min-h-screen w-screen bg-[#020205] text-[#38bdf8] overflow-x-hidden font-mono">
      ...
      {/* Retro Sci-fi CRT Scanline overlays */}
      <div className="pointer-events-none absolute inset-0 z-40 bg-[linear-gradient(rgba(18,16,16,0)_50%,rgba(0,0,0,0.25)_50%)] bg-[length:100%_4px]" />
